...
# x=torch.tensor([[-0.1,-0.1,-0.1]],dtype=torch.float64)
# x=torch.tensor([[0.1,0.2,0.5]],dtype=torch.float64)
# x=torch.tensor([[0.2,0.3,0.6]],dtype=torch.float64)

# x=torch.tensor([[0.1,0.2,0.5]],dtype=torch.float64)
# x=torch.tensor([[0.2,0.4,0.3]],dtype=torch.float64)
